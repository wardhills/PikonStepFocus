...
# from the comand line run: gksudo python telescp_cntrl.py
...
sleep = 16                       # GPIO Pin held low by defalut; a low-powered sleep mode to consume minimal current.
...
def menu_text():
    ...
    print('i     - change iso')
    print('sft f - decreate frame rate')
    print('f     - increse frame rate')
    print('m     - menu')
    return
        ...
        while True:
            with picamera.PiCamera() as camera:
                ...
                for foo in camera.capture_continuous(stream, format='jpeg', use_video_port=True):
                    ...
                    mymotor = RpiMotorLib.A4988Nema(direction, step, GPIO_pins,"A4988")  # instantiate instance ofclass, pass GPIO pins
...
## TODO add adjustment to framerate to avoid over exposure 
                                ...
                                print('returing to continuous captute')
